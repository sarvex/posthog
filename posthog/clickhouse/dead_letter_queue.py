...
KAFKA_DEAD_LETTER_QUEUE_TABLE_SQL = lambda: f"{DEAD_LETTER_QUEUE_TABLE_BASE_SQL} SETTINGS kafka_skip_broken_messages=1000".format(
    table_name=f"kafka_{DEAD_LETTER_QUEUE_TABLE}",
    cluster=CLICKHOUSE_CLUSTER,
